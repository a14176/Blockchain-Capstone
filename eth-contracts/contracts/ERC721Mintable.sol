...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "newOwner is an invalid address");
        _owner = newOwner;
        emit transferredOwnership(_owner);
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "Address is already the owner of the tokenId");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(_tokenOwner[tokenId], msg.sender) , "msg sender must be the owner of the contract or isApprovedForAll() should be true");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        if(_exists(tokenId) || to == address(0)) {
            revert("revert - given tokenId already exists or given address is invalid");
        }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "from address must be the owner of the given token");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function geName() external view returns (string memory) {
        return _name;
    }
